...
//check the length myFavoriteumber if the arr is less than 7 log 'There are not enough elements in this array' else 
//reeassign the value of 'someNum' to the value of the 7th element in the array
