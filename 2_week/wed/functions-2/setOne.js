...
// CODE HERE
const printParams =(param1,param2)=> console.log(`The first parameter is ${param1}. The second parameter is ${param2}`)

// INVOKE THE FUNCTION HERE. THE PARAMETERS TAKE ANY DATATYPE.
printParams('Hello',10)
...
greeting('Hector','Ramirez', (fullName) =>{
