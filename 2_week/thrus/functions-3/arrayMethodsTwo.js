...
const dividedNumber = numbers.map(number => number / 2 )
...
// CODE HERE
const isAppleOrOrange = fruits.forEach((fruit,index)=>{
...
const totalRicePrice = foods.filter((food)=> food.tags.includes('rice'))
                            .reduce((total,food)=> total + food.price,0)
console.log(totalRicePrice)
// THE TOTAL

const totalRicePrice2 = foods.reduce((total,food)=>{
