...
// const evenNumbers2 = mixedNumbers.filter(function(number){
//   return number % 2 === 0
// })

// const evenNumbers3 = mixedNumbers.filter((number)=>{
//   return number % 2 === 0
// })
...
const taxedOrders = orders.map(order => order.price + (order.price * order.tax))
...
// const bobsTotal2 = purchases.reduce((total,purchase)=>{
